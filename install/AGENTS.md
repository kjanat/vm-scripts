...
| ------------- | ----------------- | ------------------------- | ------------------------ |
| `uv.sh`       | uv+python+ruff+ty | Official installer + uv   | `generate_completions`   |
| `jq.sh`       | jq                | Raw binary from GitHub    | None                     |
| `shfmt.sh`    | shfmt             | Raw binary from GitHub    | None                     |
| `just.sh`     | just              | tar.gz from GitHub        | Bundled in tarball       |
| `gh.sh`       | GitHub CLI        | tar.gz from GitHub        | `gh completion`          |
